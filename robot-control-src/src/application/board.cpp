...
namespace board {
const std::uint8_t debugLed = D0;
const std::uint8_t leftMotor = D1;
const std::uint8_t rightMotor = D2;
const std::uint8_t scl = D3;
const std::uint8_t sda = D4;
const std::uint8_t rightOdoSignal = D5;
const std::uint8_t leftOdoSignal = D6;
const std::uint8_t ioExpanderIntB = D7;
const std::uint8_t ioExpanderIntAInv = D8;
